...
//
        ...
        if(check_vaccine.equals("vaccine2status"))
        {
            ...
            String check_aadhar=preferences.getString("user_aadhar","");
        ...
        book_slot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String user_slot=slot_date.getText().toString().trim();
                        ...
                        &&!dob.equals("")&&!user_slot.equals("")&&!gender.equals("-Select Gender-")&&!age_group.equals("-Select Age Group")&&!vaccine_name.equals("-Select Vaccine-")&&!hospital_name.equals("-Select Hospital-"))
                {
                     ...
                     Date today_date=calendar1.getTime();
                    dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                    String d3=dateFormat.format(today_date);
                    // Toast.makeText(location.this,d3,Toast.LENGTH_LONG).show();
                     long days1=0;
                     long hours1=0;
                     long minutes1=0;
                     try {
                        Date d1=dateFormat.parse(user_slot);
                        Date d2=dateFormat.parse(d3);
                        assert d2 != null;
                        assert d1 != null;
                    ...
                    //Toast.makeText(location.this,String.valueOf(days1),Toast.LENGTH_LONG).show();
                    SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
                    String str_time = sdf.format(new Date());
                    //Toast.makeText(location.this,str_time,Toast.LENGTH_LONG).show();
                     if(days1>0||(days1==0&&str_time.compareTo("17:00:00")<0))
                     {
                         final AlertDialog.Builder builder = new AlertDialog.Builder(location.this);
                         builder.setCancelable(true);
                         builder.setTitle("SLot Booking");
                         builder.setMessage("Are you sure you want to book slot! with these details");

                         String finalVaccine_number = vaccine_number;

                         String finalHospital_key = hospital_key;
                         String finalHospital_key1 = hospital_key;
                                                 ...
                                                 check_slotdate.child(spinner1).child(spinner2).addListenerForSingleValueEvent(new ValueEventListener() {
                                                     ...
                                                     public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                                         ...
                                                         if(vaccine_name.equals("Covaxin"))
                                                         {
                                                             ...
                                                             {
                                                                 check_slotdate.child(spinner1).child(spinner2).child(finalHospital_key).child("covaxin").child(user_aadhar).setValue("Booked");
                                                                 ...
                                                                 cur_user_vaccine.child("vaccine2hospitalkey").setValue(finalHospital_key1);


                                                                 progressBar.setVisibility(View.INVISIBLE);
                                                                 Toast.makeText(location.this,"Booking Successful",Toast.LENGTH_SHORT).show();
                                                                 Intent intent=new Intent(location.this,userhomescreen.class);
                                                         ...
                                                         else if(vaccine_name.equals("Covishield"))
                                                         {
                                                             ...
                                                             {
                                                                 check_slotdate.child(spinner1).child(spinner2).child(finalHospital_key).child("covishield").child(user_aadhar).setValue("Booked");
                                                                 cur_user_vaccine.child("fullname").setValue(user_name);
                                                                 cur_user_vaccine.child("phonenumber").setValue(user_phone);
                                                                 cur_user_vaccine.child("vaccine").setValue(vaccine_name);
                                                                 cur_user_vaccine.child("vaccine2date").setValue(user_slot);
                                                         ...
                                                         else if(vaccine_name.equals("Sputnik V"))
                                                         {
                                                             ...
                                                             {
                                                                 check_slotdate.child(spinner1).child(spinner2).child(finalHospital_key).child("sputnik").child(user_aadhar).setValue("Booked");
                                                                 cur_user_vaccine.child("fullname").setValue(user_name);
                                                                 cur_user_vaccine.child("phonenumber").setValue(user_phone);
                                                                 cur_user_vaccine.child("vaccine").setValue(vaccine_name);
                                                                 cur_user_vaccine.child("vaccine2date").setValue(user_slot);
                                                 ...
                                                 public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                                     ...
                                                     if(vaccine_name.equals("Covaxin"))
                                                     {
                                                         ...
                                                         else
                                                         {
                                                             ...
                                                             cur_user_vaccine.child("vaccinenumber").setValue(finalVaccine_number);
                                                             cur_user_vaccine.child("agegroup").setValue(age_group);
                                                             cur_user_vaccine.child("vaccine1hospitalkey").setValue(finalHospital_key);
                     ...
                     {
                         Toast.makeText(location.this,"Select Date>=today",Toast.LENGTH_SHORT).show();
                         progressBar.setVisibility(View.INVISIBLE);
                     }
                }
